...
class kncRetriever(Retriever):
    def __init__(self, embeds_size: int, use_gpu: bool = False, gpu_id: int = -1):
        """
        Initializes a new instance of kncRetriever.
    ...
    def setup_retriever(
        ...
        alignment_means = (self.
        compute_alignment_means(
    ...
    def retrieve(
        ...
        for i in tqdm(range(0, batch_query.shape[0], batch_size)):
            ...
            dis.append(batch_similarity_scores)
